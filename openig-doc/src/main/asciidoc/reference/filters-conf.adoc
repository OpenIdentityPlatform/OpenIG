...
[#PromptGuardFilter]
=== PromptGuardFilter — detect and block prompt-injection attacks
...
==== Javadoc
link:{apidocs-url}/org/openidentityplatform/openig/filter/llm/PromptGuardFilter.html[org.openidentityplatform.openig.filter.llm.PromptGuardFilter, window=_blank]
