...
----
For an example configuration, see xref:../gateway-guide/chap-logging.adoc#chap-logging-example[Section 17.3, " Separating Logs for Different Routes "] in the _Gateway Guide_ .
