...
public final class LdapConnection implements Closeable {
     ...
     * </pre>
     *
     * @param ldifLines Lines of LDIF containing the an LDIF add change record or an
     * LDIF entry record.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws UnsupportedOperationException If this connection does not support add operations.
     * @throws LocalizedIllegalArgumentException If {@code ldifLines} was empty, or contained invalid LDIF, or
     * could not be decoded using the default schema.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If {@code ldifLines} was {@code null} .
     */
     ...
     * </pre>
     *
     * @param name The distinguished name of the Directory object that the client
     * wishes to bind as, which may be empty.
     * @param password The password of the Directory object that the client wishes to
     * bind as, which may be empty.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws LocalizedIllegalArgumentException If {@code name} could not be decoded using the default
     * schema.
     * @throws UnsupportedOperationException If this connection does not support bind operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If {@code name} or {@code password} was {@code null}.
     */
     ...
     * </pre>
     *
     * @param name The distinguished name of the entry to be compared.
     * @param attributeDescription The name of the attribute to be compared.
     * @param assertionValue The assertion value to be compared.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws LocalizedIllegalArgumentException If {@code name} or {@code AttributeDescription} could not be
     * decoded using the default schema.
     * @throws UnsupportedOperationException If this connection does not support compare operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If {@code name}, {@code attributeDescription}, or
     ...
     * </pre>
     *
     * @param name The distinguished name of the entry to be deleted.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws LocalizedIllegalArgumentException If {@code name} could not be decoded using the default
     ...
     * </pre>
     *
     * @param name The distinguished name of the subtree base entry to be
     * deleted.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     ...
     * </pre>
     *
     * @param ldifLines Lines of LDIF containing the a single LDIF modify change
     * record.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     ...
     * </pre>
     *
     * @param name The distinguished name of the entry to be renamed.
     * @param newRDN The new RDN of the entry.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws LocalizedIllegalArgumentException If {@code name} or {@code newRDN} could not be decoded using
     * the default schema.
     * @throws UnsupportedOperationException If this connection does not support modify DN operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If {@code name} or {@code newRDN} was {@code null}.
     */
     ...
     * </pre>
     *
     * @param name The distinguished name of the entry to be read.
     * @param attributeDescriptions The names of the attributes to be included with the entry,
     ...
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws UnsupportedOperationException If this connection does not support search operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If the {@code name} was {@code null}.
     */
     ...
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws LocalizedIllegalArgumentException If {@code baseObject} could not be decoded using the default
     * schema.
     * @throws UnsupportedOperationException If this connection does not support search operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     ...
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If {@code request} or {@code entries} was {@code null}.
     */
     ...
     *
     * @param request The search request.
     * @param entries The collection to which matching entries should be added.
     * @return The result of the operation.
     * @throws ErrorResultException If the result code indicates that the request failed for some
     * reason.
     * @throws UnsupportedOperationException If this connection does not support search operations.
     ...
     * @param request The search request.
     * @param entries The collection to which matching entries should be added.
     * @param references The collection to which search result references should be
     ...
     * </pre>
     *
     * @param baseObject The distinguished name of the base entry relative to which the
     * search is to be performed.
     * @param scope The scope of the search.
     * @param filter The filter that defines the conditions that must be fulfilled
     * in order for an entry to be returned.
     * @param attributeDescriptions The names of the attributes to be included with each entry.
     * @return An entry reader exposing the returned entries.
     * @throws UnsupportedOperationException If this connection does not support search operations.
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If the {@code baseObject}, {@code scope}, or {@code filter}
     * were {@code null}.
     */
     ...
     * @throws IllegalStateException If this connection has already been closed, i.e. if
     * {@code isClosed() == true}.
     * @throws NullPointerException If the {@code request} was {@code null}.
     */
