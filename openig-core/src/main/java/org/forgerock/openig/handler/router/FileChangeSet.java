...
class FileChangeSet {
    ...
    /**
     * Returns {@literal true} if this {@link FileChangeSet} does not contain anything, {@literal false} otherwise.
     * @return {@literal true} if this {@link FileChangeSet} does not contain anything, {@literal false} otherwise.
     */
    public boolean isEmpty() {
        return addedFiles.isEmpty() && modifiedFiles.isEmpty() && removedFiles.isEmpty();
    }
}
