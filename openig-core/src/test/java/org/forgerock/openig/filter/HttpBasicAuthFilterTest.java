...
public class HttpBasicAuthFilterTest {
    ...
    @Test
    public void evalTest() throws ExpressionException, HandlerException, IOException, URISyntaxException {
        ...
        exchange.session = new ServletSession(new HttpServletRequest() {
            @Override
