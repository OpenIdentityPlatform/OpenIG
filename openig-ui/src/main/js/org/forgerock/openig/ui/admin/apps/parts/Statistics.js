...
define([
    ...
    AbstractView.extend({
        element: ".main",
        template: "templates/openig/admin/apps/parts/Statistics.html",
        partials: [
        ...
        render () {
            ...
            FormUtils.extendControlsSettings(this.data.controls, {
                autoTitle: true,
                autoHint: true,
                translatePath: "templates.apps.parts.statistics.fields",
        ...
        saveClick (event) {
            ...
            EventManager.sendEvent(
                Constants.EVENT_DISPLAY_MESSAGE_REQUEST,
                {
                    ...
                    filter: i18n.t("templates.apps.parts.statistics.title")
                }
            );
        },
